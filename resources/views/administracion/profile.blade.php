    ...
    <div class="col-3">
        <div class="card card-primary card-outline default_cursor_cs">
            <div class="card-body box-profile default_cursor_cs">
                ...
                <h3 class="profile-username text-center default_cursor_cs">{{Auth::user()->nombre}}</h3>
                ...
                <div class="tab-pane" id="configuracion">
                    <form class="form-horizontal default_cursor_cs">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputName" placeholder="Name" value="{{Auth::user()->nombre}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-2 col-form-label default_cursor_cs">RPE</label>
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputEmail" placeholder="000000" value="{{Auth::user()->rpe}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">

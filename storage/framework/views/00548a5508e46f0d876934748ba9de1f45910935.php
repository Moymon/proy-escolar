                ...
                <div class="card-body">
                    <div class="tab-content" id="">
                        <div class="tab-pane fade show active" id="tab-kardex" role="tabpanel">
                            <div class="d-flex justify-content-end">
                                <button class="btn btn-success" data-toggle="modal" data-target="#nuevaMateria"><i class="fas fa-plus"></i></button>
                            </div>
                            <br>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Alberto\Documents\GitHub\proy-escolar2\resources\views/licenciatura/kardex/kardex-impresion-licenciatura.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    <?php if($errors->any()): ?>
        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="alert alert-warning alert-dismissible default_cursor_cs">
                ...
                Error en la solicitud. El registro <?php echo e($error); ?> ya existe
            </div>
    ...
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('administracionuserindex')->html();
} elseif ($_instance->childHasBeenRendered('Ds0mRUN')) {
    $componentId = $_instance->getRenderedChildComponentId('Ds0mRUN');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ds0mRUN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ds0mRUN');
} else {
    $response = \Livewire\Livewire::mount('administracionuserindex');
    $html = $response->html();
    $_instance->logRenderedChild('Ds0mRUN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<script>
        ...
        objectRol.listaRoles = <?php echo json_encode($roles, 15, 512) ?>;
        ...
        function peticionAjaxSeleccionado() {
            const endpoint = '<?php echo e(route('getRolesNombre')); ?>'
            const requestData = {
                rol: objectRol.rol,
            };
        ...
        function peticionAjaxGuardar() {
            const endpoint = '<?php echo e(route('guardarRoles')); ?>'
            const requestData = {
                rol: objectRol.rol,
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Alberto\Documents\GitHub\proy-escolar2\resources\views/administracion/usuarios-index.blade.php ENDPATH**/ ?>
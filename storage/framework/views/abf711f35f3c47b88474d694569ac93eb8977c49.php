...
<?php $__env->startSection('content_header'); ?>
    ...
    -->
    <link rel="stylesheet" href="<?php echo e(asset('/css/Administracion/Roles/rolesYPermisos.css')); ?>">
                ...
                <nav id="sidebar" class="rounded">
                    ...
                    <ul id="listaRoles" style="height:60vh;overflow:auto;" class="w-100 scrollRoles ulRoles list-unstyled components">
                        ...
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="liRoles" id="<?php echo e($rol->name); ?>" data-id="<?php echo e($rol->name); ?>">
                                <div class="aRoles rolDeSidebarSeleccionable" data-target="<?php echo e($rol->name); ?>"><?php echo e($rol->name); ?></div>
                            </li>
                                ...
                                <div id="dropdown-content" class="dropdown-content border p-2">
                                    ...
                                    <div id="listaDeModulos" class="w-100 row m-0">
                                        ...
                                        <?php $__currentLoopData = $modulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="boxModulo col-3 m-0 p-0 border rounded shadow-sm">
                                                <div class="w-100 h-100 d-flex align-items-center justify-content-center p-2 labelModulo" id="<?php echo e($modulo->nombre); ?>" data-target="<?php echo e($modulo->nombre); ?>"><?php echo e($modulo->nombre); ?></div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo e(route("crearRoles")); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-group"> 
                            <div class="d-flex justify-content-around row">
                                <div class="col-12">
                                    ...
                                    <?php $__errorArgs = ['nombre_rol'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                        <p class="bg-red-500 text-danger my-2 rounded-lg text-sm p-2 text-center"><?php echo e($message); ?></p>
                                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <script type="module" src="<?php echo e(asset('js/Administracion/Roles/rolesYPermisos.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('js'); ?>
    <script>
        listaRolesJSON = <?php echo json_encode($roles, 15, 512) ?>;
        listaPermisosJSON = <?php echo json_encode($permisos, 15, 512) ?>;

        const getPermisosRelacionadosConNombre = '<?php echo e(route('getPermisosRelacionadosConNombre')); ?>';
        const guardarPermisos = '<?php echo e(route('guardarPermisos')); ?>';
        const getPermisosModuloConRol = '<?php echo e(route('getPermisosModuloConRol')); ?>';
        const guardarUsuariosXRol = '<?php echo e(route('guardarUsuariosXRol')); ?>';
        const getUsuariosXRol = '<?php echo e(route('getUsuariosXRol')); ?>';

        const rutaClassRolPermisos = "<?php echo e(asset('js/Administracion/classRolPermisos.js')); ?>";
    ...
    -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Alberto\Documents\GitHub\proy-escolar2\resources\views/administracion/roles_permisos/roles-index.blade.php ENDPATH**/ ?>
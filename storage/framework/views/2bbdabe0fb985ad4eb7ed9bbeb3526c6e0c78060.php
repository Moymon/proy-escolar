...
<li class="nav-item dropdown user-menu">
    ...
    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <li class="user-footer">
            ...
            <form id="logout-form" action="/cerrarsesion" method="POST" style="display: none;">
...
</li><?php /**PATH C:\Users\Alberto\Documents\GitHub\proy-escolar2\vendor\jeroennoten\laravel-adminlte\src/../resources/views/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>